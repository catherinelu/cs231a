...
class CropName:
    ...
    def run(self):
        blank_image = cv2.imread(os.path.join(self.directory, 'blank0.jpeg'), 0)
        ...
        for filename in os.listdir(self.directory):
            if 'blank' in filename or 'DS_Store' in filename:
                continue
            student_image = cv2.imread(os.path.join(self.directory, filename), 0)
